<template>
  <div class="addUser">
    <h1 class="main__title">Add Employee</h1>
    ...
    <form action="" class="form-add" @submit.prevent="submit">
      ...
      <div class="name select" :class="{ invalid: !department.isValid }">
      ...
      <div class="name" :class="{ invalid: !date.isValid }">
        ...
        <input
          ...
          @input="DateHandler"
          v-model="date.val"
          placeholder="2004/10/11"
        />
        <p v-if="!date.isValid">Date must not be empty</p>
      </div>
      <base-button mode="submit" type="submit">Submit</base-button>
    </form>
  </div>
</template>
